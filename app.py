...
<style>
    ...
    .stNumberInput label { color: #ff1744 !important; font-size: 0.85rem !important; font-weight: 600 !important; }
    .stButton button {
...
border:1px solid #ff1744; border-radius:10px; padding:0.8rem; margin-bottom:1rem;">
    <span style="color:#aaa; font-size:0.8rem; letter-spacing:2px;">GROUP 10 — ICT PROJECT — FLUID MECHANICS</span><br><br>
    <span style="color:#ff1744; font-size:1rem; font-weight:bold;">👤 Ahmed Rashid</span>
    <span style="color:#aaa;"> 25-ME-15</span> &nbsp;|&nbsp;
    <span style="color:#ff1744; font-size:1rem; font-weight:bold;">👤 Sheharyar Naveed</span>
    <span style="color:#aaa;"> 25-ME-35</span> &nbsp;|&nbsp;
    <span style="color:#ff1744; font-size:1rem; font-weight:bold;">👤 Ramish Ali</span>
    <span style="color:#aaa;"> 25-ME-87</span>
</div>
""", unsafe_allow_html=True)
...
if st.button("⚡  CALCULATE  ⚡", use_container_width=True):
    ...
    with g1:
        ...
        ax1.axvline(V, color='#ff1744', linestyle='--', lw=1.8, label=f'V = {V} m/s')
        ax1.axhline(delta_P, color='#ffab00', linestyle=':', lw=1.5, label=f'ΔP = {delta_P:.1f} Pa')
        ax1.scatter([V], [delta_P], color='#ff1744', s=120, zorder=6)
        ...
        ax3.axvline(L, color='#ff1744', linestyle='--', lw=1.8, label=f'L = {L} m')
        ax3.axhline(delta_P, color='#ffab00', linestyle=':', lw=1.5, label=f'ΔP = {delta_P:.1f} Pa')
        ax3.scatter([L], [delta_P], color='#ff1744', s=120, zorder=6)
    ...
    with g2:
        ...
        ax2.axvline(V, color='#ff1744', linestyle='--', lw=1.8, label=f'V = {V} m/s')
        ax2.scatter([V], [Re], color='#ff1744', s=120, zorder=6)
